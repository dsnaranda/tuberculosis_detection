...
print("\nClases de entrenamiento:", train_gen.class_indices)
print("Nº muestras por clase (train):", dict(zip(*np.unique(train_gen.classes, return_counts=True))))
print("Nº muestras por clase (val):", dict(zip(*np.unique(val_gen.classes, return_counts=True))))
...
def plot_hist():
    ...
    plt.hist(val_probs[true_labels==1], bins=25, alpha=0.6, label='TB')
...
print("Entrenamiento y evaluación finalizados, archivos en:", MODEL_DIR)
